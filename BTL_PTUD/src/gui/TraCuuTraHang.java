...
public class TraCuuTraHang extends JPanel {
    ...
    private JPanel buildFilterCard() {
        ...
        txtKeyword = new RoundedTextField(800, 50, 10, "Nh\u1eadp m\u00e3 phi\u1ebfu tr\u1ea3...");
    ...
    private JPanel buildEmptyState() {
        ...
        JLabel noteLbl = new JLabel("Ch\u1ee9c n\u0103ng tra c\u1ee9u tr\u1ea3 h\u00e0ng s\u1ebd s\u1edbm \u0111\u01b0\u1ee3c c\u1eadp nh\u1eadt.");
