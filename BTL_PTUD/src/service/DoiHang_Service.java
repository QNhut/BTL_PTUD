        ...
        try {
            ...
            if (maHD != null && !maHD.isEmpty()) {
                ...
                for (ChiTietHoaDon item : itemsReturn) {
                    ...
                    String sqlGetQty = "SELECT SoLuong FROM ChiTietHoaDon WHERE MaHD = ? AND MaSP = ?";
                    int currentQty = 0;
                    ...
                    if (newQty <= 0) {
                        String sqlDel = "DELETE FROM ChiTietHoaDon WHERE MaHD = ? AND MaSP = ?";
                        ...
                        String sqlUpd = "UPDATE ChiTietHoaDon SET SoLuong = ? WHERE MaHD = ? AND MaSP = ?";
                ...
                for (ChiTietHoaDon item : itemsNew) {
                    ...
                    String sqlCheck = "SELECT SoLuong FROM ChiTietHoaDon WHERE MaHD = ? AND MaSP = ?";
                    ...
                    if (exists) {
                        String sqlUpd = "UPDATE ChiTietHoaDon SET SoLuong = SoLuong + ?, DonGia = ? WHERE MaHD = ? AND MaSP = ?";
                        try (java.sql.PreparedStatement ps = ConnectDB.ConnectDB.getInstance().getConnection().prepareStatement(sqlUpd)) {
                        ...
                        String sqlIns = "INSERT INTO ChiTietHoaDon (MaHD, MaSP, SoLuong, DonGia) VALUES (?, ?, ?, ?)";
