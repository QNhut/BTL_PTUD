...
public class PhieuNhap_Service {
    ...
    //===Tra cứu: lấy danh sách phiếu nhập===
    public ArrayList<PhieuNhap> getDSPhieuNhap() {
        return phieuNhapDAO.getDSPhieuNhap();
    }

    //===Tra cứu: lấy chi tiết phiếu nhập theo mã===
    public ArrayList<ChiTietPhieuNhap> getChiTietTheoPhieuNhap(String maPhieuNhap) {
        return chiTietDAO.getDSTheoPhieuNhap(maPhieuNhap);
    }
